...
function isPalindrome(word)
{
    ...
    // if the word is more than one character long
        ...
        /* in case the word contains uppercase characters, the word is converted to lower case
        ("abBA" is still palindrome) */
        ...
        {
            /* if the characters are different the word is not palindrome (isSameChar will be
            false) */
